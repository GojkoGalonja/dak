		...
		<section class="bg-white dark:bg-gray-900 antialiased">
			<div class="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
				<div class="text-center">
					<div>
						<h2 class="text-3xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white sm:text-5xl lg:text-6xl">
						...
						<p class="mt-4 text-base font-normal text-gray-500 dark:text-gray-400 md:max-w-3xl md:mx-auto sm:text-xl">
							This book covers the latest design principles and techniques, including responsive design, mobile interface design, and user research
							methodologies.
						</p>
					</div>
					...
					<div class="flex items-center justify-center gap-4 mt-8 max-w-sm mx-auto">
						<a
							...
							role="button">
							<svg aria-hidden="true" class="h-8 w-8 sm:w-10 sm:h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
								<path
							...
							<div class="ml-2.5">
								<span class="block text-xs font-normal leading-none"> Download on </span>
								<span class="block text-lg font-bold leading-tight"> AppStore </span>
							</div>
						</a>
					...
					<div>
						<div class="flex items-center gap-1.5">
							<div class="flex items-center gap-0.5">
								<svg aria-hidden="true" class="w-5 h-5 text-yellow-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
									<path
